...
function question1() {  
    ...
    console.log ("Dayana Reyes")
    console.log ("Grade 11th") 
    console.log ("What I look foward to,is to understand this class")
/* 
...
function question2() {  
    ...
    let Favfood = "salvadorian pupusas" 
...
function question3() {  
    ...
    function question3() {
    function multiplyNumbs(x,y) {
     
         console.log(x * y):
         multiplyNumbs(4,  4) // Output: 16 

         multiplyNumbs(1,  5) // Output: 5 

         multiplyNumbs(6, 5) // Output: 30

         multiplyNumbs(10, 10) // Output: 108
...
function question4() {  
    ...
    let answer3 = "came1Case";
    let answer4 = "Pasca1Case";
